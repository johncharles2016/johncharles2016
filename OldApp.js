    ...
    return (
        <Provider>
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start' }}>
                ...
                <Button mode = "contained" style ={styles.button3} onPress={() => {console.log('Pressed'); showModal()}}>
                    Add Worker
                </Button>
                <Button mode = "contained" style ={styles.button3} onPress={() => {console.log('Pressed'); showModal()}}>
                    Remove Worker
                </Button>
                <Button mode = "contained" style ={styles.button3} onPress={() => {console.log('Pressed');navigation.navigate('Settings')}}>
                    Settings
                </Button>
            </View>
        </Provider>
...
function RegisterScreen({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <Button mode = "contained" style= {styles.button3} onPress={() => {console.log('Pressed'); navigation.navigate('Login')}}>
                Register
            </Button>
            <Button mode = "contained" style= {styles.button3} onPress={() => {console.log('Pressed');navigation.navigate('Login')}}>
                Login
...
function OrganizationScreen({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <Button mode = "contained" style ={styles.button3} onPress={() => {console.log('Pressed');navigation.navigate('Clockin')}}>
                Clockin Page
            </Button>
            <Button mode = "contained" style ={styles.button3} onPress={() => {console.log('Pressed');navigation.navigate('Management')}}>
                Data Management
            </Button>
        </View>
    );
        ...
        <Provider>
            <View style={styles.container}>
                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start' }}>
                    ...
                    <Button mode = "contained" style ={styles.button3} onPress={() => {console.log('Pressed');navigation.navigate('Organization')}}>
        ...
        <View style={styles.container}>
            ...
            <DataTable>
                ...
                <DataTable.Row>
                    ...
                    <DataTable.Cell><Button mode = "contained" style ={styles.button3} onPress={() => {console.log('Pressed');}}>
                        Clock in
...
function LoginScreen({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <Button mode = "contained" style ={styles.button3} onPress={() => {console.log('Pressed');navigation.navigate('Register')}}>
                Register
            </Button>
        </View>
    );
