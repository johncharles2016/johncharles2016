...
export default class ManaDep extends React.Component {
    ...
    DepDele(DepId){
        ...
        fetch(baseUrl + "/departments/remove", requestOptions)
    ...
    constructor(props) {
        ...
        fetch(baseUrl + "/users/managingDepartments", requestOptions)
            .then(response => response.text())
            .then(parsed => {
            ...
            return (
                ...
                resp.departments.map((dep) => {
                    ...
                    return <DataTable.Row key={dep.id}>
                        ...
                        <DataTable.Cell><Button mode = "contained" onPress={() => {this.props.showModal(dep.id)}}>
                            Add/Remove Worker
                        </Button></DataTable.Cell>
                        <DataTable.Cell><Button mode = "contained" onPress = {() => {this.DepDele(dep.id)}}>Delete Department</Button></DataTable.Cell>
                    </DataTable.Row>
                })
            );
        }else{
